...
const FAMILY_FAQS = [
  { question: "How does your recruitment service work?", answer: "Our entire recruitment process runs remotely via phone, email and video calls, from initial consultation through to placement. Create a family account, submit your brief, and our team begins sourcing vetted candidates." },
...
const NANNY_FAQS = [
  { question: "I'm a nanny — how do I apply?", answer: "Create a nanny account and complete your application, including your experience, availability and DBS/reference documents. Our team reviews every application personally." },
